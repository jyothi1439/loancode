...
def prediction(Gender, Married, Dependents, Education, Self_Employed, ApplicantIncome, CoapplicantIncome, LoanAmount,
	...
	#import dataset
	df = pd.read_csv(r"C:\Users\karuk\OneDrive\Desktop\loancode\loancode\Loan_Prediction_using_Django\loan\train.csv")
	...
	x_train,x_test,y_train,y_test = train_test_split(scaled,y,train_size=0.8, test_size = 0.2)
